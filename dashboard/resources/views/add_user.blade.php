                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/clothes/3.jpg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Add New User</h4>
                                    </div>
                                    <form action="/add_user_input" method="post" class="user">
                                        @csrf
                                    ...
                                    <div class="text-center"><a class="small" href="/">Go to Login Page</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
