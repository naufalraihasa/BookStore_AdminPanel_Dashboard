                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            <a class="btn btn-primary" href="/editcustomers/{{ $row->id }}">
                                <i class="fa fa-pencil"></i>
                                Edit
                            </a>
                            <a href="/deletecustomers/{{ $row->id }}" class="btn btn-danger">
...
@section('add')
    <span>
        <a class="btn btn-primary d-block btn-user w-100" href="/addcustomers"
