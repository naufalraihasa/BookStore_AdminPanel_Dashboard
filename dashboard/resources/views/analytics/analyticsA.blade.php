...
@section('sidebar')
    <li class="nav-item"><a class="nav-link" href="/analytics_store_A"><i class="far fa-chart-bar"></i><span>Analytics</span></a></li>
    <li class="nav-item">
...
@section('content')
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark mb-0">Dashboard Analytics Store A</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block"
