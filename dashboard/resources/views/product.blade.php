        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="user.html"><i class="fas fa-table"></i><span>User</span></a><a class="nav-link active" href="product.html"><i class="far fa-list-alt"></i><span>Product</span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="rounded me-2" width="30" height="30" src="assets/img/avatars/4.jpg" style="width: 130px;height: 130px;"></td>
                                            <td>Shoes X45JY</td>
                                            <td>Shirt</td>
                                            <td style="width: 400px;max-width: 400px;">Classic Men's Button-Up Shirt<br>Elevate your wardrobe with our Classic Men's Button-Up Shirt, a timeless and versatile addition to any man's collection. Crafted with attention to detail and made from premium materials, this shirt is designed to keep you looking sharp and comfortable in any setting.</td>
                                            <td>Rp 100.000</td>
                                            <td>Rp 30.000</td>
                                            <td>100</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Shoes X45JY</td>
                                            <td>Trousers</td>
                                            <td>Classic Men's Button-Up Shirt<br><br>Elevate your wardrobe with our Classic Men's Button-Up Shirt, a timeless and versatile addition to any man's collection. Crafted with attention to detail and made from premium materials, this shirt is designed to keep you looking sharp and comfortable in any setting.</td>
                                            <td>Rp 100.000</td>
                                            <td>Rp 30.000</td>
                                            <td>100</td>
                                            <td>
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col-sm-6 col-xl-1" style="margin-right: 26px;padding-right: 0px;padding-left: 0px;">
                                        <span>
                                            <a class="btn btn-primary d-block btn-user w-100" href="add-product.html" style="background: rgb(78,223,119);margin-left: 20px;margin-right: 20px;"><i class="fa fa-plus" style="font-size: 15px;margin-right: 2px;"></i>Add</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
